    ...
    <Context.Provider>
      <Context.Consumer>
        {({ ss }) => {
          ...
          const user =
            ss.Joint && "User" in ss.Joint && ss.Joint.User
              ? ss.Joint.User
              : {
          ...
          const handleViewPurchaseHistory = () => {
            navigate({ pathSegments: ["PurchaseHistory"] });
          };
            ...
            <Container style={{ backgroundColor: "#fff", flex: 1, padding: 0 }}>
              <ScrollView style={{ flex: 1 }}>
                ...
                <View style={styles.menuBox}>
                  <Button
                    _set={{ onPress: handleViewPurchaseHistory }}
                    _type="Stroke"
                  >
                    <RText>View purchase history</RText>
                  </Button>
                  <Button _set={{ onPress: () => {} }} _type="Stroke">
                    <RText>Tracking order</RText>
                  </Button>
                </View>
                <View style={styles.menuBox}>
                  <RText style={styles.sectionTitle}>Support</RText>
                  <Button _set={{ onPress: () => {} }} _type="Stroke">
                    <RText>Support center</RText>
                  </Button>
                  <Button _set={{ onPress: () => {} }} _type="Stroke">
                    <RText>Chat with CosmePlay</RText>
                  </Button>
                  <Button _set={{ onPress: () => {} }} _type="Stroke">
                    <RText>Web platform</RText>
                  </Button>
                </View>
              </ScrollView>
            </Container>
